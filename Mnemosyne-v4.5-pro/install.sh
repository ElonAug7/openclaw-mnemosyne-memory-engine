...
echo "🧠 Mnemosyne v4.5 安装程序"
echo ""
echo "   v4 核心特性："
echo "   🧠 记忆回响：context · recall · report · profile · ask"
echo "   🔮 话题续接：>12h 自动检测上回聊到哪"
echo "   🏷️  话题标签：#decision #planning #tech #preference"
echo "   📊 质量自评：每块摘要自动评估完整性"
echo "   💓 心跳图：30天活跃度热力图"
echo "   ⏳ 时光机：MEMORY.md 历史版本浏览恢复"
echo "   🌱 成长日志：长期记忆增量自动记录"
echo ""
